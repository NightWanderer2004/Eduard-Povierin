   ...
   projects: [
      {
         ...
         info: 'Made a smooth app using framer-motion & shadcn. Also I made a connection to Google Sheets API',
      },
      {
         title: 'Fancy MBTI',
         ...
         info: 'Made a super tool to help people with finding their power and weaknesses. App is using GPT-4',
      },
      {
      ...
      },
      {
         ...
         info: 'A very simple blog made using 11ty and vanilla JS. My first great project!',
      },
      {
         title: 'Actify',
